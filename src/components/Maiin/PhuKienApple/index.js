...
class PhuKienApple extends Component {
  ...
  showView=(arr)=>{
    ...
    render() {
        ...
        <div className={classes.wrapper}>
          <h2 className={classes.wrapper1}><span></span><span> </span>Phu kien Applechinh hang</h2>
...
export default  withStyles(styles)(PhuKienApple)